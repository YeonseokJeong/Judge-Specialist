...
def evaluate(model, dataset, tokenizer, collator, opt, step=None, num_batch=None):
    ...
    with torch.no_grad():
        for i, batch in enumerate(dataloader):
            ...
            outputs, seq_scores, seq_lens = model.cand_generate(
            ...
            #print('seq_scores shape:',seq_scores.shape)
            ...
            # (idx, context_ids, context_mask, seq, seq_scores, seq_lens, ems)
            ...
            extended_batch = (idx, context_ids, context_mask, outputs, seq_scores, seq_lens, ems)
